...
const blogContent = {
  "dry-skin-in-summer": {
    ...
    content: `
      ...
      <p><strong style="color:blue;">Why Summer Makes Your Skin Dry</strong></p><br />
      <ul>
      ...
      <p><strong>7-Step Summer Skincare Regimen for Dry Skin</strong></p><br />
      <ol>
        <li><strong>1. Gentle Cleansing:</strong> Use a mild, hydrating cleanser twice a day to remove dirt and impurities without stripping your skin's natural oils.</li>
        <li><strong>2. Exfoliate (1-2 Times a Week):</strong> Gently exfoliate to remove dead skin cells and allow moisturizers to penetrate deeper.</li>
        <li><strong>3. Hydrating Toner:</strong> A toner with hyaluronic acid or glycerin can help replenish moisture and balance your skin's pH.</li>
        <li><strong>4. Serum Power:</strong> Look for serums containing hyaluronic acid, vitamin C, or niacinamide to boost hydration and repair your skin's barrier.</li>
        <li><strong>5. Moisturize, Moisturize, Moisturize!</strong> Choose a rich moisturizer with ingredients like ceramides, shea butter, or squalane to lock in moisture and soothe dryness.</li>
        <li><strong>6. Sunscreen is Non-Negotiable:</strong> Apply a broad-spectrum sunscreen with SPF 30 or higher every day, even on cloudy days.</li>
        <li><strong>7. Hydrate from Within:</strong> Drink plenty of water throughout the day to keep your skin hydrated from the inside out.</li>
      </ol><br />

      <p><strong>Home Remedies for Dry Summer Skin</strong></p><br />
      <ul>
      ...
      <p><strong>Additional Tips:</strong></p><br />
      <ul>
  ...
  "reverse-fatty-liver": {
    ...
    content: `
      ...
      <p><strong style="color:blue;">Understanding Fatty Liver</strong></p><br />
      <p>Before diving into the remedies, let's briefly understand what fatty liver is. There are two main types:</p>
      <ul>
        <li><strong>Non-alcoholic fatty liver disease (NAFLD):</strong> This is the most common type and is not caused by excessive alcohol consumption.</li>
      ...
      <p><strong>5 Home Remedies to Tackle Fatty Liver</strong></p><br />
      <ol>
        <li><strong>Embrace a Healthy Diet:</strong>
          <ul>
            ...
            <li>Opt for the Mediterranean diet, which emphasizes plant-based foods and healthy fats.</li>
          </ul>
        </li>
        <li><strong>Maintain a Healthy Weight:</strong>
          <ul>
            ...
            <li>Regular exercise, combined with a healthy diet, is key to achieving and maintaining a healthy weight.</li>
          </ul>
        </li>
        <li><strong>Coffee to the Rescue:</strong>
          <ul>
            <li>Studies suggest that coffee may have protective effects on the liver.</li>
            <li>Moderate coffee consumption (2-3 cups per day) is associated with a reduced risk of liver disease progression.</li>
          </ul>
        </li>
        <li><strong>Herbal Allies:</strong>
          <ul>
            ...
            <li>Consult with a healthcare professional before starting any herbal supplements.</li>
          </ul>
        </li>
      ...
      <p><strong>Important Note:</strong></p><br />
  ...
  "summer-energy-drinks": {
    ...
    content: `
      ...
      <p><strong style="color:blue;">1. Watermelon Electrolyte Refresher:</strong></p><br />
      ...
      <p><strong style="color:blue;">2. Tropical Green Smoothie:</strong></p><br />
      ...
      <p><strong style="color:blue;">3. Ginger Lemon Zinger:</strong></p><br />
      ...
      <p><strong style="color:blue;">4. Iced Matcha Latte:</strong></p><br />
      ...
      <p><strong style="color:blue;">5. Coconut Water with Chia Seeds:</strong></p><br />
  ...
  "acidity-relief": {
    ...
    content: `
      ...
      <p><strong style="color:blue;">Understanding Acidity and Its Triggers</strong></p><br />
      <p>Acidity occurs when stomach acid flows back up into the esophagus, causing irritation and that familiar burning sensation. Common triggers include:</p>
      <ul>
      ...
      <p><strong style="color:blue;">14 Home Remedies for Acidity Relief</strong></p><br />
      <ol>
        <li><strong>Baking Soda:</strong> Mix a teaspoon of baking soda in a glass of water for a quick antacid effect.</li>
        <li><strong>Ginger:</strong> Chew on a small piece of ginger or sip ginger tea to soothe the stomach and reduce inflammation.</li>
        <li><strong>Aloe Vera Juice:</strong> Drink a small amount of pure aloe vera juice before meals to calm the digestive tract.</li>
        <li><strong>Apple Cider Vinegar:</strong> Despite its acidic nature, ACV can help balance stomach pH when diluted in water.</li>
        <li><strong>Chamomile Tea:</strong> Sip chamomile tea to soothe the stomach and reduce inflammation.</li>
        <li><strong>Fennel Seeds:</strong> Chew on a teaspoon of fennel seeds after meals to aid digestion and freshen breath.</li>
        <li><strong>Cold Milk:</strong> The calcium in milk can neutralize stomach acid.</li>
        <li><strong>Bananas:</strong> Rich in potassium, bananas can help counteract excess acid production.</li>
        <li><strong>Almonds:</strong> Almonds are naturally alkaline and can help neutralize stomach acid.</li>
        <li><strong>Licorice Root:</strong> Chewing on deglycyrrhizinated licorice (DGL) can help soothe the esophageal lining.</li>
        <li><strong>Slippery Elm:</strong> This herb forms a protective coating in the stomach and esophagus, reducing irritation.</li>
        <li><strong>Probiotics:</strong> These beneficial bacteria can help restore balance in the gut and reduce acid reflux symptoms.</li>
        <li><strong>Chewing Gum:</strong> Chewing gum can stimulate saliva production, which helps neutralize acid.</li>
        <li><strong>Staying Upright After Meals:</strong> Avoid lying down for at least two hours after eating to prevent acid reflux.</li>
      </ol><br />

      <p><strong>Important Considerations:</strong></p><br />
      <ul>
        <li><strong>Consult Your Doctor:</strong> If you experience frequent or severe acidity, consult your doctor to rule out any underlying medical conditions.</li>
        <li><strong>Moderation:</strong> While these remedies are generally safe, use them in moderation and stop if you experience any adverse effects.</li>
        <li><strong>Lifestyle Changes:</strong> Making changes like eating smaller meals, avoiding trigger foods, and managing stress can also significantly improve acidity.</li>
      </ul><br />
  ...
  "moringa-health-benefits": {
    ...
    content: `
      ...
      <p><strong style="color:blue;">The Nutritional Powerhouse</strong></p><br />
      <p>Moringa leaves boast an impressive nutritional profile, including:</p>
      <ul>
        <li><strong>Vitamins:</strong> A, C, B1 (thiamine), B2 (riboflavin), B3 (niacin), B6, and folate</li>
        <li><strong>Minerals:</strong> Calcium, potassium, iron, magnesium, phosphorus, zinc</li>
        <li><strong>Antioxidants:</strong> Quercetin, chlorogenic acid, and various polyphenols</li>
        <li><strong>Amino Acids:</strong> All nine essential amino acids</li>
        <li><strong>Other Nutrients:</strong> Fiber, protein, beta-carotene</li>
      </ul><br />

      <p><strong style="color:blue;">16 Health Benefits of Moringa Leaves</strong></p><br />
      <ol>
        <li><strong>Rich in Antioxidants:</strong> Protects cells from damage, fights inflammation, and boosts immunity.</li>
        <li><strong>Lowers Blood Sugar Levels:</strong> May help manage diabetes and reduce complications.</li>
        <li><strong>Reduces Inflammation:</strong> Combats chronic inflammation linked to various diseases.</li>
        <li><strong>Lowers Cholesterol:</strong> Improves heart health by reducing bad cholesterol levels.</li>
        <li><strong>Protects the Liver:</strong> Aids in detoxification and promotes liver health.</li>
        <li><strong>Improves Digestive Health:</strong> Supports gut health and may alleviate digestive issues.</li>
        <li><strong>Protects Against Arsenic Toxicity:</strong> May help mitigate the harmful effects of arsenic exposure.</li>
        <li><strong>Enhances Bone Health:</strong> Provides essential nutrients for strong bones.</li>
        <li><strong>Fights Infections:</strong> Possesses antimicrobial properties that may help fight bacterial and fungal infections.</li>
        <li><strong>Boosts Energy Levels:</strong> Offers a natural energy boost due to its nutrient density.</li>
        <li><strong>Improves Brain Function:</strong> Supports cognitive function and may protect against neurodegenerative diseases.</li>
        <li><strong>Promotes Healthy Skin and Hair:</strong> Contains nutrients that nourish skin and hair, promoting a youthful appearance.</li>
        <li><strong>Supports Lactation:</strong> May increase milk production in breastfeeding mothers.</li>
        <li><strong>Aids in Weight Management:</strong> May help with weight loss by reducing cravings and boosting metabolism.</li>
        <li><strong>Protects the Cardiovascular System:</strong> Helps regulate blood pressure and improve overall heart health.</li>
        <li><strong>Detoxifies the Body:</strong> Aids in eliminating toxins and heavy metals.</li>
      </ol><br />

      <p><strong style="color:blue;">How to Incorporate Moringa Leaves</strong></p><br />
      <ul>
        <li><strong>Powder:</strong> Add to smoothies, soups, sauces, or yogurt.</li>
        <li><strong>Tea:</strong> Steep dried leaves to make a nutritious tea.</li>
        <li><strong>Capsules or Supplements:</strong> Convenient for those who prefer a supplement form.</li>
      </ul><br />

      <p><strong>Precautions and Considerations:</strong></p><br />
      <ul>
        <li><strong>Pregnancy and Breastfeeding:</strong> Consult your doctor before using moringa during pregnancy or breastfeeding.</li>
        <li><strong>Medication Interactions:</strong> Moringa may interact with certain medications, so talk to your doctor if you're taking any prescription drugs.</li>
      </ul><br />
...
const BlogDetails = () => {
  ...
  return (
    <>
      <div className="w-100 h-auto px-[100px] py-12 bg-white flex-col justify-start items-start gap-5 inline-flex">
        <div className="self-stretch justify-between items-center inline-flex">
          ...
          <div className="self-stretch justify-start items-center gap-2 flex">
            <img className="w-10 h-10 relative rounded-[64px]" src={BlogImage} alt="Author" />
        ...
        <img className="w-full h-[344px] relative rounded-lg" src={blog?.image||BlogImage} alt="Blog" />
