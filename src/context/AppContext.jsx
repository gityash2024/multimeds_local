...
export function AppContext({children}) {
  ...
  return (
    ...
    <Context.Provider value={{setCartList,selectedProduct,setDone,done,setSelectedProduct,handleRefetchCart,cartListFromContext,useWallet,setUseWallet,userWalletDebit,setAmountDebitedFromWallet,setUserLoggedIn,isLoggedIn}}>
